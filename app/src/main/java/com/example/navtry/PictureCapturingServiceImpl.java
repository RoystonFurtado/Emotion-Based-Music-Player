...
public class PictureCapturingServiceImpl extends APictureCapturingService {
    ...
    private void takePicture() throws CameraAccessException {
        ...
        //Gets all the JPEG Image sizes supported by this camera and uses the Max Resolution for the image.
        ...
        //Create a surface for capturing highest resolution JPEG Images
        outputSurfaces.add(reader.getSurface());
        //Create a Capture request with specific settings
        ...
        captureBuilder.set(CaptureRequest.JPEG_ORIENTATION, getOrientation(sensorOrientation));
        //Once the image has been captured save it to local storage
...
//Saves the image to Internal Storage/<CameraID>_pic.jpg
